  ...
  <v-container>
    ...
    >
      ...
      <template v-slot:[`item.phone`]="{ item }">
        <span v-if="item.read">{{ item.phone }}</span>
        <span v-if="!item.read" :style="style">{{ item.phone }}</span>
      </template>
      <template v-slot:[`item.email`]="{ item }">
        <span v-if="item.read">{{ item.email }}</span>
        <span v-if="!item.read" :style="style">{{ item.email }}</span>
      </template>
      <template v-slot:[`item.message`]="{ item }">
        <span v-if="item.read">{{ shortMessage(item.message) }}</span>
        <span v-if="!item.read" :style="style">{{ shortMessage(item.message) }}</span>
      </template>
